...
- **Đua xe:** không dùng mạng. Trả lời đúng thì xe quay đầu lên và tiến 1 bước. Trả lời sai thì xe quay ngược và lùi 1 bước (ở vạch xuất phát thì đứng im), đồng thời xe ma được thưởng thêm 1 bước. Về đích trước xe ma là thắng. Xe ma tiến từng bước theo thời gian, không phụ thuộc câu trả lời, và nhanh dần. Bước đầu mất 10 giây (`FIRST_STEP_MS`), mỗi bước sau ngắn hơn 12% (`GHOST_ACCEL`), về đích sau khoảng 60 giây. Khi đã có kỷ lục, nhịp bước được co giãn để xe ma về đích đúng bằng kỷ lục.
